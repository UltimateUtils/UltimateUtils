...
public static partial class DoubleExtensions
{
    ...
    public static bool TryParse([NotNullWhen(true)] this string? number, out double result)
    {
        return double.TryParse(number, out result);
    }

    public static bool TryParse(this ReadOnlySpan<char> number, out double result)
    {
        return double.TryParse(number, out result);
    }

    public static bool TryParse(this ReadOnlySpan<byte> number, out double result)
    {
        return double.TryParse(number, out result);
    }
