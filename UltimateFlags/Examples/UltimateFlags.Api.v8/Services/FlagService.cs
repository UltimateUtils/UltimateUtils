...
public class FlagService : IFlagService
{
    ...
    {
        return _flagService.Get(name, parentId);
    }
    ...
    {
        return _flagService.ExecutePurge(id);
    }

    public int ExecutePurge(DateTime? fromInclusive = null, DateTime? toInclusive = null)
    {
        return _flagService.ExecutePurge(fromInclusive, toInclusive);
    }
