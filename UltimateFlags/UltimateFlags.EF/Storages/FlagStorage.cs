...
internal class FlagStorage : IFlagStorage
{
    ...
    public Flag? Get(Guid id)
    {
        ...
        return found; // todo - global filter 동작 여부 확인
    ...
    //                     && flag.ParentId == parentId);
    //
    //     _EnsureExists(flag, $"{nameof(FlagStorage)}.{nameof(Enable)}(name, parentId)");
    //
    //     if (flag.IsOn)
    //         return;
    //
    ...
    //     Flag? flag = _flagDbContext.Flags.Find(id);
    //
    //     _EnsureExists(flag, $"{nameof(FlagStorage)}.{nameof(Disable)}(id)");
    //
    //     if (!flag.IsOn)
    //         return;
    //
    ...
    //
    //     _EnsureExists(flag, $"{nameof(FlagStorage)}.{nameof(Disable)}(name, parentId)");
    //
    //     if (!flag.IsOn)
    //         return;
    //
    ...
    public async Task EnableAsync(Guid id, CancellationToken cancellationToken = default)
    {
        ...
        _EnsureExists(flag, $"{nameof(FlagStorage)}.{nameof(EnableAsync)}(id, cancellationToken)");
    ...
    public async Task EnableAsync(string name, Guid? parentId, CancellationToken cancellationToken = default)
    {
        ...
        _EnsureExists(flag, $"{nameof(FlagStorage)}.{nameof(EnableAsync)}(name, parentId, cancellationToken)");
    ...
    public async Task DisableAsync(Guid id, CancellationToken cancellationToken = default)
    {
        ...
        _EnsureExists(flag, $"{nameof(FlagStorage)}.{nameof(DisableAsync)}(id, cancellationToken)");
    ...
    public async Task DisableAsync(string name, Guid? parentId, CancellationToken cancellationToken = default)
    {
        ...
        _EnsureExists(flag, $"{nameof(FlagStorage)}.{nameof(DisableAsync)}(name, parentId, cancellationToken)");
